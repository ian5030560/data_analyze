from .db import CPI, AgeFertility, FemaleLabor
from .util import getCorrelationWithFertility, useAllData
import pandas as pd

def getAgeFertility() -> list[int, float]:
    """計算每年的平均生育年齡
    """
    data = useAllData(AgeFertility)
